...
public class Student extends Person {
	...
	public static class StudentGenerator {
		private static String[] names = {"Mario", "Mariya", "Stoyan", "Petyr", "Petya", "Lilly", "Eli", "Viktor", "Alex"};
		private static String[] specialities = {"Informatics", "STD", "BIT", "Mathematics", "STE"};
		...
		public static Student make() {
			...
			int weight = ThreadLocalRandom.current().nextInt(50, 120);
